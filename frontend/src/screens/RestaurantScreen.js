...
exports.RestaurantScreen = void 0;
...
const _RestaurantScreen = (props) => {
    ...
    return (<react_native_1.View style={styles.container}>
            ...
            <react_native_1.View style={styles.body}>
                <react_native_1.ImageBackground source={{ uri: `${restaurant.images[0]}` }} style={{
            ...
            justifyContent: 'flex-end'
                ...
                <react_native_1.FlatList showsHorizontalScrollIndicator={false} data={restaurant.foods} renderItem={({ item }) => <FoodCard_1.default item={(0, utils_1.checkExistence)(item, Cart)} onTap={onTapFood} onUpdateCart={props.onUpdateCart}/>} keyExtractor={(item) => `${item._id}`}/>
            </react_native_1.View>
      </react_native_1.View>);
};
...
const RestaurantScreen = (0, react_redux_1.connect)(mapStateToProps, { onUpdateCart: userActions_1.onUpdateCart })(_RestaurantScreen);
exports.RestaurantScreen = RestaurantScreen;
//# sourceMappingURL=RestaurantScreen.js.map